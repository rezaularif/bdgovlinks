export const translations = {
  ...
  bn: {
    ...
    directoryInfo:
      'এটি বাংলাদেশের সরকারি ওয়েবসাইটগুলির একটি অনীহারিক ডিরেক্টরি। সুবিধার জন্য সমস্ত লিঙ্ক নতুন ট্যাবে খোলে। আপনি যদি কোনও ভাঙা লিঙ্ক খুঁজে পান বা এই ডিরেক্টরিতে সংযোজন প্রস্তাবনা করতে চান তবে আমাদের জানান।',
    feedback: 'প্রতিক্রিয়া',
    help: 'সাহায্য',
    copyright: (year: number) =>
      `© ${year} BdGovLinks. আরিফ দ্বারা তৈরি`,
    english: 'English',
    bangla: 'বাংলা',
    categories: {
